import 'package:caps/views/profil.dart';
...
class artikelRujukan extends StatelessWidget {
  ...
  void _launchYouTubeURL() async {
    const youtubeURL = 'https://www.youtube.com/watch?v=m1SUt24g2L0&ab_channel=CNNIndonesia';
  ...
  void _launchYouTubeURL1() async {
    const youtubeURL = 'https://www.youtube.com/watch?v=vj5hvNPzsxA&ab_channel=HelloSehat';
  ...
  void _launchYouTubeURL2() async {
    const youtubeURL = 'https://www.youtube.com/watch?v=htY0Z7SEYR4&ab_channel=Alodokter';
  ...
  void _launchYouTubeURL3() async {
    const youtubeURL = 'https://www.youtube.com/watch?v=pfW6mP_9qOA&ab_channel=SKWADHealth';
  ...
  void _launchYouTubeURL4() async {
    const youtubeURL = 'https://www.youtube.com/watch?v=4iPVQlKFvlM&ab_channel=SatuPersen-IndonesianLifeSchool';
